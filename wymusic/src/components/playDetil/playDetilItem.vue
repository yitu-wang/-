    ...
    <div class="container">
      <div class="left">
        <div class="header">
          ...
          <div class="right">
            ...
            <div class="auther">
              ...
              <span>{{ formatDate(playListData.createTime) }} 创建</span>
            </div>
            <div class="btn">
              <button>
              ...
              <button>
                <i class="el-icon-chat-line-square">
                  ({{ playListData.subscribedCount }})</i
                >
              </button>
            </div>
            <div class="tip">
            ...
            <p class="text" v-html="playListData.description"></p>
          </div>
        </div>
        ...
        <div class="footer center">
          ...
          <div class="footer">
            <h4>最热评论({{ playComment.hotComments.length }})</h4>
            <ul>
              <li v-for="item in playComment.hotComments" :key="item.commentId">
            ...
            <h4>最新评论({{ playComment.comments.length }})</h4>
            <ul>
              <li v-for="item in playComment.comments" :key="item.commentId">
                <img :src="item.user.avatarUrl" alt="" />
                <p class="name">
                  {{ item.user.nickname }}
                </p>
      ...
      <div class="right">
        ...
        <ul>
          <li
            v-for="item in playListData.subscribers"
            :key="item.id"
            class="imgLi"
          >
        ...
        <h4>&nbsp&nbsp 热门歌单</h4>
        <ul>
          <li
            v-for="item in relatedPlay"
            :key="item.id"
            @click="
              $router.push({
...
<script>
import { musicUrlApi, musicDetailApi, userCommentApi } from '@/request/api.js'
